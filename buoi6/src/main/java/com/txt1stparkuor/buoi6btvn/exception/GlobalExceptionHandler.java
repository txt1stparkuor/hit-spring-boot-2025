package com.txt1stparkuor.buoi6btvn.exception;

import com.txt1stparkuor.buoi6btvn.base.ResponseUtil;
import com.txt1stparkuor.buoi6btvn.base.RestData;
...
public class GlobalExceptionHandler {
    // phan exception kho nen em chatgpt kha nhieu de tim hieu sau
    ...
    public ResponseEntity<RestData<?>> handleConstraintViolationException(ConstraintViolationException ex) {
        ...
        log.warn("Validation failed for request parameters/path variables: {}", errors);
        return ResponseUtil.error(HttpStatus.BAD_REQUEST, errors);
    }
